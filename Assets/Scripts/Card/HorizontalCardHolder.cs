...
public class HorizontalCardHolder : MonoBehaviour
{
    ...
    public void ReturnOriginPosition(Card card)
    {
        if (card == null)
        {
            Debug.Log("isnull");
        ...
        card.transform.DOLocalMove(
            card.selected ? new Vector3(0, card.selectionOffset, 0) : Vector3.zero,
